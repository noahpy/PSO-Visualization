...
c_pso.call_fittness_func.argtypes = [POINTER(c_float), c_size_t, c_int, c_int]
c_pso.call_fittness_func.restype = None
...
def blackbox_func(x,y):
    ...
    c_coordinates[1] = y
    result = 0
    c_pso.call_fittness_func(c_coordinates, 2, func_id, result)
    return result
